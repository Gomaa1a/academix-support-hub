      ...
      <div className="relative h-screen flex items-center justify-center bg-gradient-to-br from-[#0a0a0a] to-[#1a1a1a]">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center gap-8">
            <img src="/lovable-uploads/ab810b06-eb1e-4730-aeda-b27b77723d87.png" alt="Academix AI" className="w-64 mb-6" />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="p-6 bg-gray-900/50 border-orange-500/20">
              <h3 className="text-xl font-semibold mb-4">24/7 AI Support</h3>
